          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="{{route('specialities.index')}} ">Afficher Specialité</a></li>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">{{$student -> series}}</td>
                            <td> <button  class="btn btn-primary m-t-15 waves-effect">Update</button></td>
                            <td><form action="#" method="POST">@csrf @method('DELETE')<button  class="btn btn-danger m-t-15 waves-effect">Delete</button></form> </td>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="sexe" name="sex">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" placeholder="Niveau" name="level">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="specialité" name="speciality">
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Filière</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="filière" name="series">
                    </div>
                  </div>
                  <div class="form-group">
