                        ...
                        <tbody>
                            @foreach ($specialities as $speciality )
                                <tr>
                                    ...
                                    <td><form action="{{route('specialities.destroy',$speciality -> speciality)}}" method="POST">@csrf @method('DELETE')<button  class="btn btn-danger m-t-15 waves-effect">Delete</button></form> </td>
                                </tr>
                            @endforeach
                        </tbody>
                      </table>
                ...
                @csrf
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" placeholder="idSpecialité" name="specialityid">
                    </div>
                  </div>
                  <div class="form-group">
